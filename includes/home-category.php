			...
			<div class="col-xl-12">
				...
				<div class="categories-container">
					...
					<a href="jobs-grid-layout-full-page.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 612</div>
					...
					<a href="jobs-list-layout-full-page-map.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 113</div>
						<div class="category-box-content">
					...
					<a href="jobs-list-layout-full-page-map.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 186</div>
						<div class="category-box-content">
					...
					<a href="jobs-list-layout-1.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 298</div>
						<div class="category-box-content">
					...
					<a href="jobs-list-layout-2.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 549</div>
						<div class="category-box-content">
					...
					<a href="jobs-list-layout-1.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 873</div>
						<div class="category-box-content">
					...
					<a href="jobs-list-layout-2.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 125</div>
						<div class="category-box-content">
					...
					<a href="jobs-grid-layout-full-page.html" class="category-box">
						...
						<div class="category-box-counter"><i class="icon-feather-user-plus"></i> 445</div>
						<div class="category-box-content">

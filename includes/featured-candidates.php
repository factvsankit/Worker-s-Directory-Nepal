...
<div class="section gray padding-top-65 padding-bottom-70 full-width-carousel-fix margin-top-45">
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-12">
				...
				<div class="section-headline margin-top-0 margin-bottom-25">
					...
					<a href="freelancers-grid-layout.html" class="headline-link">Browse All Candidates</a>
				</div>
			</div>
